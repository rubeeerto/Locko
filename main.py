...
async def referral_program(message: types.Message):
    ...
    # Використовуємо тільки параметр text з посиланням - Telegram автоматично розпізнає URL і зробить його клікабельним
    share_text = f"Привіт! Приєднуйся до нашого боту! 📱\nЗавдяки тобі ми зможемо зростати та робити для тебе ще більше 🚀\n\n{referral_link}"
    encoded_text = urllib.parse.quote(share_text)
    # Використовуємо тільки text без url параметра - так Telegram точно зробить посилання в тексті клікабельним
