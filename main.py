...
async def ukr(number, chat_id, proxy_url=None, proxy_auth=None):
    ...
    first_requests = [
        ...
        bounded_request("https://brabrabra.ua/auth/modal.php?login=yes&ajax_mode=Y", **with_proxy({"data": {"sessid": cookies_brabra["PHPSESSID"], "step": "1", "phone": formatted_number9, "ajax_mode": "Y"}, "headers": headers_brabra, "cookies": cookies_brabra})),
